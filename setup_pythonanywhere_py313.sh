...
# PythonAnywhere Python 3.13 Setup Script
# This script handles Python 3.13 compatibility issues

echo "=== PythonAnywhere Python 3.13 Setup Script ==="
echo "This script will set up your Label Maker application on PythonAnywhere with Python 3.13"
echo ""
...
mkvirtualenv --python=/usr/bin/python3.13 AGTDesigner
...
echo ""
echo "=== Setup Summary ==="
echo "✅ Virtual environment created: AGTDesigner (Python 3.13)"
echo "✅ Dependencies installed (Python 3.13 compatible)"
...
echo ""
echo "🎉 Python 3.13 setup completed!" 