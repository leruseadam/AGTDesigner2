...
from src.core.data.excel_processor_optimized import get_optimized_excel_processor, OptimizedExcelProcessor
excel_processor = get_optimized_excel_processor()
